...
export const transpiledFieldsPatterns: Array<RegExp> = [
  ...
  /^(preAggregations|pre_aggregations)\.[_a-zA-Z][_a-zA-Z0-9]*\.(clusteredBy|clustered_by)$/,
  /^(preAggregations|pre_aggregations)\.[_a-zA-Z][_a-zA-Z0-9]*\.(partitionedBy|partitioned_by)$/,
